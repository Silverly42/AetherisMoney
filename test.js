...
test('shows the current sell prices',()=>{
  ...
  for (const entry of ['Diamond</span><strong>3,000 M$','Lapis Lazuli</span><strong>125 M$','Netherite Ingot</span><strong>12,000 M$','Oak Log</span><strong>5 M$','Cherry Log</span><strong>5 M$','Netherrack</span><strong>5 M$','Any mob drop music disc</span><strong>10,000 M$']) assert.match(html,new RegExp(entry.replace('$','\\$')));
});
